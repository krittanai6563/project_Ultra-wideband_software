  ...
  <div id="kt_sidebar" class="sidebar bg-warning" data-kt-drawer="true" data-kt-drawer-name="sidebar"
    ...
    <div class="d-flex flex-column sidebar-body">
      <div id="kt_sidebar_content" class="py-10 px-7 px-lg-12">
        <div class="hover-scroll-y me-lg-n7 pe-lg-5" data-kt-scroll="true" data-kt-scroll-height="auto"
          data-kt-scroll-offset="0px" data-kt-scroll-wrappers="#kt_sidebar_content"
          data-select2-id="select2-data-113-koyy" style="height: 400px;">
        ...
        <button @click="drawRoom()">Update Room Size</button>
              ...
              <div class="mb-8" v-if="isEditing">
                ...
                <input class="form-control form-control-solid form-control-lg" type="number" id="editedRoomWidth"
                  v-model="editedRoomWidth" @keyup.enter="drawRoo()">
                <div class="mb-2"></div>
                <label class="fw-bold" for="editedRoomHeight">ความยาว:</label>
                <input class="form-control form-control-solid form-control-lg" type="number" id="editedRoomHeight"
                  v-model="editedRoomHeight" @keyup.enter="drawRoom()()">
                <div class="mb-3"></div>
              ...
              <div class="mb-1">
                ...
                <button class="form-control form-control-solid form-control-lg"
                  @click="setRoomSize('small')">Small</button>
              </div>
              <div class="mb-1">

                <button class="form-control form-control-solid form-control-lg"
                  @click="setRoomSize('medium')">Medium</button>
              </div>
              <div class="mb-8">

                <button class="form-control form-control-solid form-control-lg"
                  @click="setRoomSize('large')">Large</button>
              </div>
              ...
              <div class="mb-8">
                ...
                <button class="color-picker-button" ref="colorButton" @click="openColorPicker"
                  :style="{ backgroundColor: backgroundColor }" style="width: 20px; height: 20px;"></button>
              </div>




               <button @click="showImage" class="button">
          <img src="../../public/images/sofa.svg" alt="Show Image" style="width: 60px; height: 60px;" />
        </button>

        <button @click="showdining_table" class="button">
        <img src="../../public/images/stool-chair.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>



         <button @click="Scfa_Chair" class="button">
          <img src="../../public/images/sofa_chair.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

          <button @click="Double_Sofa" class="button">
            <img src="../../public/images/double_sofa.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>
  
            <button @click="Triple_Sofa" class="button">
              <img src="../../public/images/triple_sofa.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>
  
   <button @click="Sofa_set_1" class="button">
                <img src="../../public/images/Sofa_set_1.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                <button @click="Sofa_set_2" class="button">
                  <img src="../../public/images/Sofa_set_2.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                    <button @click="Sofa_set_3" class="button">
                    <img src="../../public/images/Sofa_set_3.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                      <button @click="Sofa_set_4" class="button">
                    <img src="../../public/images/Sofa_set_4.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                     <button @click="dining_table" class="button">
                      <img src="../../public/images/dining_table.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                      <button @click="dining_table_1" class="button">
                        <img src="../../public/images/dining_table_1.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                        <button @click="dining_table_2" class="button">
                        <img src="../../public/images/dining_table_2.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                        <button @click="dining_table_3" class="button">
                      <img src="../../public/images/dining_table_3.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>

                      <button @click="dining_table_4" class="button">
                        <img src="../../public/images/dining_table_4.svg" alt="Show Image" style="width: 60px; height: 60px;" /></button>
            </div>
            <!--end::Product Info-->
...
export default {
  ...
  methods: {
    ...
    showImage() {
      const url = '../../public/images/sofa.svg';
      ...
      showdining_table() {
      const url = '../../public/images/stool-chair.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
        const scale = Math.min(scaleX, scaleY);
        img.set({
          left: room.left + (room.width - img.width * scale) / 2,
          top: room.top + (room.height - img.height * scale) / 2,
          scaleX: scale,
          scaleY: scale,
      ...
      Scfa_Chair() {
      const url = '../../public/images/sofa_chair.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
      ...
      Double_Sofa() {
      const url = '../../public/images/double_sofa.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
      ...
      Triple_Sofa() {
      const url = '../../public/images/triple_sofa.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
    ...
    Sofa_set_1() {
      const url = '../../public/images/Sofa_set_1.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
       ...
       Sofa_set_2() {
      const url = '../../public/images/Sofa_set_2.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
      ...
      Sofa_set_3() {
      const url = '../../public/images/Sofa_set_3.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
       ...
       Sofa_set_4() {
      const url = '../../public/images/Sofa_set_4.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
      ...
      dining_table() {
      const url = '../../public/images/dining_table.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
      ...
      dining_table_1() {
      const url = '../../public/images/dining_table_1.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
      ...
      dining_table_2() {
      const url = '../../public/images/dining_table_2.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
        ...
        this.canvasObjects.push(img);
          ...
          dining_table_3() {
      const url = '../../public/images/dining_table_3.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
        ...
        this.canvasObjects.push(img);
          ...
          dining_table_4() {
      const url = '../../public/images/dining_table_4.svg';
      fabric.Image.fromURL(url, img => {
        const room = this.fabricCanvas.item(0);
        const scaleX = room.width / img.width;
        const scaleY = room.height / img.height;
